 ...
 */
class PythonFunctionDeployTemplate extends BaseDeployTemplate {
...
${template.uploadArtifactStep()}
        - name: DEPLOY_APPLICATION_${template.environment.toUpperCase()}_${template.profile.toUpperCase()}
          ...
          command:
            ...
            jobOptions:
            - environment=${Environment.findDeploymentEnvironmentCodeForPythonFunctions(template.profile, template.environment)}
